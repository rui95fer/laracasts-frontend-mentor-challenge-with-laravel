...
{{-- Order Total --}}
<dl class="flex items-center justify-between py-6">
...
{{-- Confirm Order --}}
<button type="button" class="mt-6 w-full bg-red text-white font-semibold py-4 rounded-full hover:bg-red/90 transition-colors cursor-pointer">
    Confirm Order
</button>
